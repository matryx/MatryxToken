...
contract Crowdsale is Ownable, Haltable {
  ...
  function Crowdsale(uint256 _presaleStartTime, uint256 _startTime, uint256 _endTime, address _wallet, address _token) public {
  ...
  function updateWhitelist(address _purchaser, bool _listed) public onlyOwner {
